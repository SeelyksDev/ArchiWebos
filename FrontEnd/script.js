...
const selectPictureBtn = document.createElement("button");
...
const addModale = () => {
    ...
    selectPictureBtn.classList.add("select-picture");
    selectPictureBtn.textContent = "+ Ajouter photo";
    ...
    addBtn.classList.add("add-btn", "valid-btn");
    addBtn.textContent = "Valider";
    alignModaleAdd.appendChild(addBtn);
};
